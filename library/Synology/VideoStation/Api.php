...
class Synology_VideoStation_Api extends Synology_Api_Authenticate{
	...
	public function getObjects($type, $limit = 25, $offset = 0){
		...
		switch ($type){
			case 'Movie':
				$path = 'VideoStation/movie.cgi';break;
			case 'TVShow':
				$path = 'VideoStation/tvshow.cgi';break;
			case 'TVShowEpisode':
				$path = 'VideoStation/tvshow_episode.cgi';break;
			case 'HomeVideo':
				$path = 'VideoStation/homevideo.cgi';break;
			case 'TVRecording':
				$path = 'VideoStation/tvrecord.cgi';break;
			case 'Collection':
				$path = 'VideoStation/collection.cgi';break;
			case 'Library':
				$path = 'VideoStation/library.cgi';break;
			default:
